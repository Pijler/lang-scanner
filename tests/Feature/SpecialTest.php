...
test('it should run default command with special characters (text-g)', function () {
    ...
    expect($output)->toContain('SCANNED', '2 files, New 20 translations scanned');
