...
test('it should run default command (test-i)', function () {
    [$status, $output] = run('default', [
        '--config' => base_path('tests/Fixtures/test-i/scanner.json'),
    ]);

    expect($status)->toBe(1);
    expect($output)->toContain('SCANNED', '2 files, New 21 translations scanned');

    expect(getContent(base_path('tests/Fixtures/test-i/lang/en-US.json')))->toBe([
        'App Description' => 'App Description',
        'App Name' => '',
        'App Version' => '',
        'App. Description!' => 'App. Description!',
    ...
    expect(getContent(base_path('tests/Fixtures/test-i/lang/pt-BR.json')))->toBe([
        'App Description' => '',
        'App Name' => 'Nome App',
        'App Version' => 'Versão App',
        'App. Description!' => '',
